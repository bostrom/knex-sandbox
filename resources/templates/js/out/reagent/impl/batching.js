...
var or__4251__auto__ = (w["requestAnimationFrame"]);
if(cljs.core.truth_(or__4251__auto__)){
return or__4251__auto__;
} else {
var or__4251__auto____$1 = (w["webkitRequestAnimationFrame"]);
if(cljs.core.truth_(or__4251__auto____$1)){
return or__4251__auto____$1;
} else {
var or__4251__auto____$2 = (w["mozRequestAnimationFrame"]);
if(cljs.core.truth_(or__4251__auto____$2)){
return or__4251__auto____$2;
} else {
var or__4251__auto____$3 = (w["msRequestAnimationFrame"]);
...
var n__5136__auto__ = a.length;
var i = (0);
while(true){
if((i < n__5136__auto__)){
var c_9336 = (a[i]);
if(cljs.core.truth_((c_9336["cljsIsDirty"]))){
(c_9336["forceUpdate"])();
} else {
}
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"queue","queue",-1198599890,null),new cljs.core.Symbol(null,"scheduled?","scheduled?",579986609,null)], null);
});
...
reagent.impl.batching.RenderQueue.cljs$lang$ctorPrWriter = (function (this__4830__auto__,writer__4831__auto__,opt__4832__auto__){
return cljs.core._write.call(null,writer__4831__auto__,"reagent.impl.batching/RenderQueue");
});
...
var G__9339 = c;
var G__9339__$1 = (((G__9339 == null))?null:(G__9339["props"]));
var G__9339__$2 = (((G__9339__$1 == null))?null:(G__9339__$1["argv"]));
return G__9339__$2;
});
...
var G__9341_9342 = (c["cljsRatom"]);
var G__9341_9343__$1 = (((G__9341_9342 == null))?null:reagent.ratom.dispose_BANG_.call(null,G__9341_9342));
